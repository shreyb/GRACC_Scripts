...
# Wrapper script to run the OSG Top Opportunistic Usage report
...
LOGFILE=/home/sbhat/gracc-reporting-IO/log/gracc-reporting/topoppusage_run.log  # Ideally should be in /var/log/gracc-reporting
CONFIGFILE=/home/sbhat/gracc-reporting-IO/config/osg.toml
TEMPLATEFILE=/home/sbhat/gracc-reporting-IO/html_templates/template_topoppusage.html
VENVDIR=gracc_venv
...
osgtopoppusagereport -s "$starttime" -e "$endtime" -N 10 -c $CONFIGFILE -T $TEMPLATEFILE
